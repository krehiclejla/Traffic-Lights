...
public class GreenVehicle extends Pane {
    protected final Rectangle body;

    public GreenVehicle(String type, String direction) {
        super();

        body = new Rectangle(20, 20, Color.GREEN);
    ...
    private void setDirection(String direction) {
        ...
        System.out.println("Created a " + direction + " Green Vehicle with rotation: " + getRotate());
    }
}
