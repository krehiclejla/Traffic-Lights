...
public class YellowVehicle extends Pane {
    protected final Rectangle body;

    public YellowVehicle(String type, String direction) {
        super();

        body = new Rectangle(20, 20, Color.YELLOW);
    ...
    private void setDirection(String direction) {
        ...
        System.out.println("Created a " + direction + " Yellow Vehicle with rotation: " + getRotate());
    }
}
